...
import Day025_02.Rabbit;

public class Class031_1_package_외부 {
	public static void main(String[] args) {
		...
		r1.setB_protected(100);// protected : 패키지 _ 자식 / getter + setter 필요함
		r1.setC_package(10);//package : 패키지  / getter + setter 필요함
		//pivate : 클래스내에서만(멤버함수가 멤버변수 접근해서 사용)
		r1.setA_private(1);
